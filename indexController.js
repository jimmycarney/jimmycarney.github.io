...
app.controller('myCtrl', function($scope, $http) {
    ...
    {title:'Pitch Perfect',genre:'comedy',rating:0,imageSrc:''},{title:'Blades of Glory',genre:'comedy',rating:0,imageSrc:''},{title:'The Benchwarmers',genre:'comedy',rating:0,imageSrc:''},{title:'Tower Heist',genre:'comedy',rating:0,imageSrc:''},{title:'Zero Dark Thirty',genre:'action',rating:0,imageSrc:''}];
