...
app.controller('myCtrl', function($scope, $http) {
    ...
    {title:'Incredibles 2',genre:'superhero',rating:0,imageSrc:'https://m.media-amazon.com/images/M/MV5BMTEzNzY0OTg0NTdeQTJeQWpwZ15BbWU4MDU3OTg3MjUz._V1_SX300.jpg'},{title:'Widows',genre:'action',rating:0,imageSrc:'https://m.media-amazon.com/images/M/MV5BMjM3ODc5NDEyOF5BMl5BanBnXkFtZTgwMTI4MDcxNjM@._V1_SX300.jpg'},{title:'Wreck it Ralph',genre:'comedy',rating:0,imageSrc:'https://m.media-amazon.com/images/M/MV5BNzMxNTExOTkyMF5BMl5BanBnXkFtZTcwMzEyNDc0OA@@._V1_SX300.jpg'},{title:'Ralph Breaks the Internet',genre:'comedy',rating:0,imageSrc:'https://m.media-amazon.com/images/M/MV5BMTYyNzEyNDAzOV5BMl5BanBnXkFtZTgwNTk3NDczNjM@._V1_SX300.jpg'},{title:'Godzilla: King of the Monsters',genre:'scifi',rating:0,imageSrc:'https://m.media-amazon.com/images/M/MV5BOGFjYWNkMTMtMTg1ZC00Y2I4LTg0ZTYtN2ZlMzI4MGQwNzg4XkEyXkFqcGdeQXVyMTkxNjUyNQ@@._V1_SX300.jpg'},
    ...
    {title:'The LEGO Movie',genre:'comedy',rating:0,imageSrc:''},{title:'Zootopia',genre:'comedy',rating:0,imageSrc:''},{title:'Inside Out',genre:'comedy',rating:0,imageSrc:''},{title:'Up',genre:'comedy',rating:0,imageSrc:''},
    {title:'Ratatouille',genre:'comedy',rating:0,imageSrc:''},{title:'Groundhog Day',genre:'comedy',rating:0,imageSrc:''},{title:'Monsters, Inc.',genre:'comedy',rating:0,imageSrc:''},{title:'Wonder Woman',genre:'superhero',rating:0,imageSrc:''},
    {title:'12 Angry Men',genre:'drama',rating:0,imageSrc:''},{title:'Creed',genre:'drama',rating:0,imageSrc:''},{title:'Creed II',genre:'drama',rating:0,imageSrc:''},{title:'Ghostbusters',genre:'comedy',rating:0,imageSrc:''},{title:'The Express',genre:'drama',rating:0,imageSrc:''},
    {title:'Hoosiers',genre:'drama',rating:0,imageSrc:''},{title:'Invincible',genre:'drama',rating:0,imageSrc:''},{title:'Invictus',genre:'drama',rating:0,imageSrc:''},{title:'The Blind Side',genre:'drama',rating:0,imageSrc:''},{title:'Robin Hood: Men in Tights',genre:'comedy',rating:0,imageSrc:''},
    {title:'Skyfall',genre:'action',rating:0,imageSrc:''},{title:'Moana',genre:'comedy',rating:0,imageSrc:''},{title:'The Cabin in the Woods',genre:'thriller',rating:0,imageSrc:''},{title:'Shaun of the Dead',genre:'comedy',rating:0,imageSrc:''},{title:'Chronicle',genre:'superhero',rating:0,imageSrc:''},];
