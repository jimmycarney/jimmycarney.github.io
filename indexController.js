...
app.controller('myCtrl', function($scope, $http) {
    ...
    {title:'Demon Slayer',genre:'animated',year:'2019',rating:83,imageSrc:'https://m.media-amazon.com/images/M/MV5BZjZjNzI5MDctY2Y4YS00NmM4LTljMmItZTFkOTExNGI3ODRhXkEyXkFqcGdeQXVyNjc3MjQzNTI@._V1_SX300.jpg'}];
    ...
    $scope.compareQBs = function() {
        for (i = 0; i < $scope.eaglesQBStats.length; i++) {
            ...
            $scope.eaglesQBComparison = $scope.eaglesQBComparison.concat($scope.eaglesQBStats[i].stats);
        }
    }
